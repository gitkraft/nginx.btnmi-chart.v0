...
<p align="center">
    <a href="https://gitkraft.com/router?gk_operation=fork&gk_name=nginx.btnmi-chart.v0&gk_template_owner=tpl-gitkraft&gk_template_name=tpl.nginx.btnmi-chart.v0&gk_description=Helm%20chart%20for%20nginx%2C%20managed%20with%20GitKraft%20tooling&gk_visibility=private&mtm_campaign=fork&mtm_kwd=nginx.btnmi-chart.v0">
...
This repository hosts the GitKraft's open-source **nginx** Helm chart, originally
